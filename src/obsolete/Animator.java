...
public class Animator {
	...
	public void setAnim (PImage i, Move m, int start, int frames, int animSpeed) {
		this.setAnim (i, m, start, frames, animSpeed, false);
	}
	
	public void setAnim (PImage i, Move m, int start, int frames, int animSpeed, boolean change) {
