...
public abstract class Graphics implements Serializable<Graphics> {
	...
	public class Settings implements Serializable<Settings> {
		...
		@Override
		public Settings deserialize(ByteHelper b, Serializable<?>... prototypes) {
			// TODO Auto-generated method stub
			return null;
		}
		@Override
	...
	@Override
	public Graphics deserialize(ByteHelper b, Serializable<?>... prototypes) {
		// TODO Auto-generated method stub
		this.load(null);
		return null;
	}
