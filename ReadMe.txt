...
#4:	 Go through ToolKit and create new dist function that doesnt take square root and replace with that function
#5:	 Make basic physics engine to expand upon, make all MoveSet classes implement physics class and use
...
#6:	 Move away from processing and use built in java functions. I dont want any external jars
...
#14: Make working menu system along with text boxes
...
#20: Implement an UI that can be called upon as a function. I will try to make an outline here:
...
#21: Implement PlatformerComplexMove (Maybe do me sooner because I'll be easy with physics implemented!)
